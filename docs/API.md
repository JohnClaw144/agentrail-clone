...
```
> `summary` is generated by Google Gemini 2.5 Flash via Replicate when `REPLICATE_API_TOKEN` is configured. It will be `null` otherwise.
...
[
  {
    ...
    "status": "completed",
    "tx_hash": "0x...",
    "summary": "Agent captured the Stripe hero and extracted $1,821.53",
